...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180918170257_AddMyIdentity')
BEGIN
...
BEGIN
    ...
    VALUES (N'20180918170257_AddMyIdentity', N'2.1.2-rtm-30932');
END;
